...
public class SQL {
    ...
    private final String url = "jdbc:mysql://mysql-db.caprover.diplomportal.dk:3306/s205492";
    private final String DatabaseUser = "s205492";
    private final String DatabasePassword = System.getenv("L6KqKjFnnRg1UWpcCQF8D"); //tomcat system startups
